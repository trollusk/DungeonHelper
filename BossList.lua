...
local DHData = {
    ...
    ["stonefalls"] = {
        ...
        ["balsunn_b3"] = {},
        ["balsunn_b3trans"] = {},
        ["balsunn_caves"] = {{0.6, 0.4, DH_GetLocalizedData("stonefalls", "balsunn_caves", "urvel"), "SECRET"}, -- Urvel Drath
                             {0.9, 0.6, DH_GetLocalizedData("stonefalls", "balsunn_caves", "roksa")} -- Roksa the Warped
        },
        ["balsunn_deidric"] = {{0.5, 0.1, DH_GetLocalizedData("stonefalls", "balsunn_deidric", "lladi"), "FINAL"} -- Lladi Telvanni
        },
    ...
    ["glenumbra"] = {
        ...
        ["rpb_map_int001"] = {{0.5, 0.8, DH_GetLocalizedData("glenumbra", "rpb_map_int001", "artifact_bearers")}, -- Eliam Merick, Ihudir, and Liramindrel
        ...
        ["rpb_map_int002"] = {},
        ["rpb_map_int003"] = {{0.5, 0.7, DH_GetLocalizedData("glenumbra", "rpb_map_int003", "spider_daedra"), "SECRET"} -- Spider Daedra
        },
        ["rpb_map_secret001"] = {}
    ...
    ["grahtwood"] = {
        ...
        ["maarsmap04_base"] = {{0.2, 0.8, DH_GetLocalizedData("grahtwood", "maarsmap04_base", "cancroid"), "PUGKILLER"} -- Azurblight Cancroid
        },
        ["maarsmap05_base"] = {{0.8, 0.2, DH_GetLocalizedData("grahtwood", "maarsmap05_base", "selene"), "PUGKILLER"} -- Selene's Claws and Selene's Fangs
        },
        ["maarsmap06_base"] = {{0.8, 0.7, DH_GetLocalizedData("grahtwood", "maarsmap06_base", "maarselok_final"),
                                "FINAL PUGKILLER"} -- Maarselok (Final Battle)
        },
        ["maarsoutsidemap001_base"] = {}, -- entrance
        ["maarsoutsidemap003_base"] = {{0.5, 0.25,
                                        DH_GetLocalizedData("grahtwood", "maarsoutsidemap003_base", "maarselok"),
                                        "PUGKILLER"} -- Maarselok
        }
    ...
    ["stormhaven"] = {
        ...
        {0.37, 0.20, DH_GetLocalizedData("stormhaven", "scalecaller001_base", "orzun_rinaerus"), "PUGKILLER"}, -- Orzun the Foul-Smelling and Rinaerus the Rancid
        {0.68, 0.46, DH_GetLocalizedData("stormhaven", "scalecaller001_base", "doyemish"), "PUGKILLER"} -- Doyemish Ironheart
        },
        ["scalecaller002_base"] = {{0.3, 0.2, DH_GetLocalizedData("stormhaven", "scalecaller002_base", "aldis"),
                                    "PUGKILLER"} -- Matriarch Aldis
        },
        ["scalecaller003_base"] = {},
        ["scalecaller004_base"] = {{0.25, 0.8, DH_GetLocalizedData("stormhaven", "scalecaller004_base", "mortieu")}, -- Plague Concocter Mortieu
                                   {0.9, 0.5, DH_GetLocalizedData("stormhaven", "scalecaller004_base", "zaan"),
                                    "FINAL PUGKILLER"} -- Zaan the Scalecaller
        }
    ...
    ["rivenspire"] = {
        ...
        {0.81, 0.70, DH_GetLocalizedData("rivenspire", "lostshipyard_map001", "sailor"), "SECRET"}, -- Storm-Cursed Sailor
                                   {0.83, 0.55, DH_GetLocalizedData("rivenspire", "lostshipyard_map001", "numirril"),
                                    "FINAL"} -- Captain Numirril
        }
    ...
    ["shadowfen"] = {
        ...
        ["ui_cradleofshadowsint_002_base"] = {{0.2, 0.5,
                                               DH_GetLocalizedData("shadowfen", "ui_cradleofshadowsint_002_base",
            "khephidaen")}, -- Khephidaen the Spiderkith
        {0.8, 0.8, DH_GetLocalizedData("shadowfen", "ui_cradleofshadowsint_002_base", "sithera")} -- Sithera
        },
        ["ui_cradleofshadowsint_003_base"] = {{0.5, 0.2,
                                               DH_GetLocalizedData("shadowfen", "ui_cradleofshadowsint_003_base",
        ...
        ["ui_cradleofshadowsint_005_base"] = {{0.5, 0.5,
                                               DH_GetLocalizedData("shadowfen", "ui_cradleofshadowsint_005_base",
            "velidreth"), "FINAL PUGKILLER"} -- Velidreth
        }
    }, -- End Shadowfen
    ...
    ["eastmarch"] = {
        ...
        ["frvfrstvlt02_base"] = {{0.761996, 0.713715, DH_GetLocalizedData("eastmarch", "frvfrstvlt02_base", "rizzuk")} -- Rizzuk Bonechill
        },
        ["frvfrstvlt04_base"] = {{0.575249, 0.569783,
                                  DH_GetLocalizedData("eastmarch", "frvfrstvlt04_base", "stonekeeper"),
                                  "FINAL PUGKILLER"} -- The Stonekeeper
        }
    ...
    ["bangkorai"] = {
        ...
        ["unhallowedgravemap002"] = {{0.5, 0.5, DH_GetLocalizedData("bangkorai", "unhallowedgravemap002", "keeper"),
    ...
    ["therift"] = {
        ...
        ["u37_scrivenershall_sect2b_map"] = {{0.7, 0.1,
                                              DH_GetLocalizedData("therift", "u37_scrivenershall_sect2b_map", "ozezan")} -- Ozezan the Inferno
        },
        ["u37_scrivenershall_sect3a_map"] = {},
        ["u37_scrivenershall_sect3b_map"] = {{0.4, 0.2,
                                              DH_GetLocalizedData("therift", "u37_scrivenershall_sect3b_map", "valinna"),
                                              "FINAL"} -- Valinna
        },
    ...
    ["reapersmarch"] = {
        ...
        ["mhkmoonhunterkeep2_base"] = {{0.7, 0.5,
                                        DH_GetLocalizedData("reapersmarch", "mhkmoonhunterkeep2_base", "guardian")} -- Hedge Maze Guardian
        },
        ["mhkmoonhunterkeep3_base"] = {{0.2, 0.7,
                                        DH_GetLocalizedData("reapersmarch", "mhkmoonhunterkeep3_base", "mylenne")}, -- Mylenne Moon-Caller
                                       {0.5, 0.25,
                                        DH_GetLocalizedData("reapersmarch", "mhkmoonhunterkeep3_base", "ernarde"),
        ...
        ["mawlorkajhall_base"] = {},
        ["mawlorkajsevenriddles_base"] = {{0.7, 0.5,
                                           DH_GetLocalizedData("reapersmarch", "mawlorkajsevenriddles_base", "rakkhat")} -- Rakkhat
        },
    ...
    ["craglorn"] = {
        -- == Falkreath Hold ==--
        ["falkreathsdemise_b_base"] = {{0.5, 0.9,
                                        DH_GetLocalizedData("craglorn", "falkreathsdemise_b_base", "domihaus"), "FINAL"} -- Domihaus
        },
        ["falkreathsdemise_i_base"] = {{0.5, 0.8,
                                        DH_GetLocalizedData("craglorn", "falkreathsdemise_i_base", "deathlord")} -- Deathlord Bjarfrud Skjoralmor
        },
        ...
        ["bloodrootint1_base"] = {{0.5, 0.4, DH_GetLocalizedData("craglorn", "bloodrootint1_base", "stoneheart"),
                                   "DPSCHECK"}, -- Stoneheart
        {0.9, 0.6, DH_GetLocalizedData("craglorn", "bloodrootint1_base", "galchobhar"), "PUGKILLER DPSCHECK"} -- Galchobhar
        },
        ["bloodrootint2_base"] = {{0.5, 0.7, DH_GetLocalizedData("craglorn", "bloodrootint2_base", "gherig")}, -- Gherig Bullblood
        ...
        ["helracitadelhallofwarrior_base"] = {{0.5, 0.2,
                                               DH_GetLocalizedData("craglorn", "helracitadelhallofwarrior_base",
            "warrior"), "FINAL"} -- The Warrior
        },
        ...
        ["aetherianarchiveislandb_base"] = {{0.5, 0.66,
                                             DH_GetLocalizedData("craglorn", "aetherianarchiveislandb_base", "varlariel"),
                                             "DPSCHECK"} -- Varlariel
        },
        ["aetherianarchiveislandc_base"] = {{0.5, 0.5,
                                             DH_GetLocalizedData("craglorn", "aetherianarchiveislandc_base", "mage"),
                                             "FINAL DPSCHECK"} -- The Mage
        },
        ...
        ["trl_so_map02_base"] = {{0.28, 0.64, DH_GetLocalizedData("craglorn", "trl_so_map02_base", "manticora"),
                                  "DPSCHECK"}, -- Possessed Manticora
        {0.465, 0.39, DH_GetLocalizedData("craglorn", "trl_so_map02_base", "stonebreaker")} -- Stonebreaker
        },
        ["trl_so_map03_base"] = {{0.6, 0.4, DH_GetLocalizedData("craglorn", "trl_so_map03_base", "ozara"), "PUGKILLER"}, -- Ozara
    ...
    ["darkbrotherhood"] = {
        ...
        ["domdepthsofmal2_base"] = {{0.3, 0.3, DH_GetLocalizedData("darkbrotherhood", "domdepthsofmal2_base", "weeping")} -- The Weeping Woman
        },
        ["domdepthsofmal3_base"] = {{0.3, 0.3,
                                     DH_GetLocalizedData("darkbrotherhood", "domdepthsofmal3_base", "dark_orb")}, -- The Dark Orb
                                    {0.3, 0.65,
                                     DH_GetLocalizedData("darkbrotherhood", "domdepthsofmal3_base", "narilmor")}, -- King Narilmor
                                    {0.8, 0.5, DH_GetLocalizedData("darkbrotherhood", "domdepthsofmal3_base", "blades"),
                                     "FINAL"} -- Symphony of Blades
        },
        ...
        ["bdvilla_map2ext2"] = {{0.50, 0.20, DH_GetLocalizedData("darkbrotherhood", "bdvilla_map2ext2", "encratis")} -- Pyroturge Encratis
        },
        ["bdvilla_boss3map"] = {{0.5, 0.6, DH_GetLocalizedData("darkbrotherhood", "bdvilla_boss3map", "aksalaz")} -- Sentinel Aksalaz
        },
        ["bdvilla_map3int1"] = {{0.5, 0.9, DH_GetLocalizedData("darkbrotherhood", "bdvilla_map3int1", "geminus")} -- Captain Geminus
        },
        ["bdvilla_mapsecret1"] = {{0.20, 0.40, DH_GetLocalizedData("darkbrotherhood", "bdvilla_mapsecret1", "zeal")} -- Avatar of Zeal
        },
        ["bdvilla_mapsecret2"] = {{0.60, 0.90, DH_GetLocalizedData("darkbrotherhood", "bdvilla_mapsecret2", "vigor")} -- Avatar of Vigor
        },
        ["bdvilla_mapsecret3"] = {{0.60, 0.70, DH_GetLocalizedData("darkbrotherhood", "bdvilla_mapsecret3", "fortitude")} -- Avatar of Fortitude
        }
    }, -- end Gold Coast	
    ...
    ["southernelsweyr"] = {
        ...
        ["moongravesection2_base"] = {{0.6, 0.5,
                                       DH_GetLocalizedData("southernelsweyr", "moongravesection2_base", "drozakar")} -- Dro'zakar 
        },
        ["moongravesection3_base"] = {{0.5, 0.6,
                                       DH_GetLocalizedData("southernelsweyr", "moongravesection3_base", "kujo")} -- Kujo Kethba
        },
        ["moongravesection4_base"] = {{0.5, 0.4,
                                       DH_GetLocalizedData("southernelsweyr", "moongravesection4_base", "nisaazda")}, -- Nisaazda
                                      {0.6, 0.3,
                                       DH_GetLocalizedData("southernelsweyr", "moongravesection4_base", "grundwulf")} -- Grundwulf
        }
    ...
    ["wrothgar"] = {
        ...
        ["u41_bv_sc1_map"] = {{0.72, 0.61, DH_GetLocalizedData("wrothgar", "u41_bv_sc1_map", "shattered_champion")},
                              {0.88, 0.25, DH_GetLocalizedData("wrothgar", "u41_bv_sc2_map", "darkshard")},
                              {0.5, 0.75, DH_GetLocalizedData("wrothgar", "u41_bv_sc2_map", "the_blind"), "FINAL"}}
    }, -- end Wrothgar
    ...
    ["vvardenfell"] = {
        ...
        ["hofabrichall1_base"] = {},
        ["hofabricloop_base"] = {{0.8, 0.5, DH_GetLocalizedData("vvardenfell", "hofabricloop_base", "archcustodian")} -- The Archcustodian
        },
        ["hofabricboss3_base"] = {{0.5, 0.3, DH_GetLocalizedData("vvardenfell", "hofabricboss3_base", "assembly")} -- The Assembly General
        },
        ["hofabricext1_base"] = {{0.7, 0.5, DH_GetLocalizedData("vvardenfell", "hofabricext1_base", "committee")} -- The Refabrication Committee
        },
        ["hofabrichall2_base"] = {}
    }, -- end Vvardenfell
    ...
    ["clockwork"] = {
        ...
        ["asylumsanctorum002_base"] = {{0.61, 0.19,
                                        DH_GetLocalizedData("vvardenfell", "asylumsanctorum002_base", "llothis")}, -- Saint Llothis the Pious
                                       {0.61, 0.85,
                                        DH_GetLocalizedData("vvardenfell", "asylumsanctorum002_base", "felms")}, -- Saint Felms the Bold
                                       {0.65, 0.52,
                                        DH_GetLocalizedData("vvardenfell", "asylumsanctorum002_base", "olms")} -- Saint Olms the Just
        }
    }, -- end Clockwork City
    ...
    ["murkmire"] = {
        ...
        ["blackroseprison01_base"] = {{0.59, 0.83, DH_GetLocalizedData("murkmire", "blackroseprison01_base", "ennodius")}, -- Battlemage Ennodius
                                      {0.34, 0.75,
    ...
    ["skyrim"] = {
        -- == Castle Thorn (DLC) ==--
        ["castlethornmap_001"] = {{0.56, 0.51, DH_GetLocalizedData("skyrim", "castlethornmap_001", "tindulra")}, -- Dread Tindulra
        ...
        ["castlethorn_int_01"] = {{0.30, 0.30, DH_GetLocalizedData("skyrim", "castlethorn_int_01", "twilight")} -- Blood Twilight
        },
        ["castlethorn_int_02"] = {},
        ["castlethorn_int_03"] = {{0.40, 0.50, DH_GetLocalizedData("skyrim", "castlethorn_int_03", "lady_thorn"), "FINAL"} -- Lady Thorn
        },

        -- == Stone Garden (DLC) ==--
        ["stonegarden01_base"] = {{0.66, 0.17, DH_GetLocalizedData("skyrim", "stonegarden01_base", "kraglen")} -- Exarch Kraglen
        },
        ["stonegarden02"] = {},
        ["stonegarden02b_base"] = {{0.5, 0.5, DH_GetLocalizedData("skyrim", "stonegarden02b_base", "behemoth")} -- Stone Behemoth
        },
        ["stonegarden03"] = {},
        ["stonegarden03b_base"] = {{0.5, 0.5, DH_GetLocalizedData("skyrim", "stonegarden03b_base", "arkasis")} -- Arkasis the Mad Alchemist
        },
    ...
    ["reach"] = {
        ...
        ["u41_osp_map_starterarea"] = {{0.42, 0.40,
                                        DH_GetLocalizedData("reach", "u41_osp_map_starterarea", "rethelros_malthil")},
                                       {0.5, 0.65, DH_GetLocalizedData("reach", "u41_osp_map_starterarea", "anthelmir")},
                                       {0.5, 0.35, DH_GetLocalizedData("reach", "u41_osp_map_starterarea", "aradros"), "FINAL"},
                                       {0.65, 0.5, DH_GetLocalizedData("reach", "u41_osp_map_starterarea", "sluthrug"),
                                        "SECRET"},
                                       {0.35, 0.5, DH_GetLocalizedData("reach", "u41_osp_map_starterarea", "bolg"),
                                        "SECRET"},
                                       {0.75, 0.75,
                                        DH_GetLocalizedData("reach", "u41_osp_map_starterarea", "grubduthag"), "SECRET"}}
    }, -- end The Reach
    ...
    ["blackwood"] = {
        ...
        ["tdc_map_inside_001"] = {{0.5, 0.8, DH_GetLocalizedData("blackwood", "tdc_map_inside_001", "cyronin")}, -- Cyronin Artellian
                                  {0.4, 0.5, DH_GetLocalizedData("blackwood", "tdc_map_inside_001", "magma_incarnate"), "FINAL"} -- Magma Incarnate
        },
        ["tdc_map_outside_001"] = { -- first area
        {0.20, 0.38, DH_GetLocalizedData("blackwood", "tdc_map_outside_001", "broodlord")} -- Scorion Broodlord
        },
        ["tdc_map_secret_001"] = {},
        ["tdc_map_secrethall_001"] = {{0.5, 0.5, DH_GetLocalizedData("blackwood", "tdc_map_secrethall_001", "purgator"),
                                       "SECRET"} -- Purgator
        },
        ["tdc_map_secrethall_002"] = {{0.5, 0.7,
                                       DH_GetLocalizedData("blackwood", "tdc_map_secrethall_002", "undertaker"),
                                       "SECRET"} -- Undertaker
        },
        ["tdc_map_secrethall_003"] = {{0.5, 0.9, DH_GetLocalizedData("blackwood", "tdc_map_secrethall_003", "warden"),
                                       "SECRET"} -- Grim Warden
        },

        -- == Rockgrove (TRIAL) ==--
        ["rg_map_inside_001"] = {},
        ["u30_rg_map_outside_001"] = {{0.37, 0.46,
                                       DH_GetLocalizedData("blackwood", "u30_rg_map_outside_001", "oaxiltso")}, -- Oaxiltso
                                      {0.50, 0.69, DH_GetLocalizedData("blackwood", "u30_rg_map_outside_001", "bahsei")} -- Flame-Herald Bahsei
        },
        ["u30_rg_map_outside_002"] = {{0.5, 0.5, DH_GetLocalizedData("blackwood", "u30_rg_map_outside_002", "xalvakka")} -- Xalvakka
        }
    }, -- end Blackwood
    ...
    ["summerset"] = {
        -- == Coral Aerie (DLC) ==--
        ["coralaerie_b1_001"] = {{0.5, 0.6, DH_GetLocalizedData("summerset", "coralaerie_b1_001", "maligalig")} -- Maligalig
        },
        ["coralaerie_b2_001"] = {{0.5, 0.9, DH_GetLocalizedData("summerset", "coralaerie_b2_001", "sarydil")} -- Sarydil
        },
        ["coralaerie_beach_001"] = {{0.51, 0.23,
                                     DH_GetLocalizedData("summerset", "coralaerie_beach_001", "sword_guardian"),
                                     "SECRET"} -- Sword Guardian
        },
        ["coralaerie_mbwave_001"] = {{0.9, 0.3,
                                      DH_GetLocalizedData("summerset", "coralaerie_mbwave_001", "staff_guardian"),
                                      "SECRET"}, -- Staff Guardian
        {0.8, 0.4, DH_GetLocalizedData("summerset", "coralaerie_mbwave_001", "szarzo")} -- S'zarzo the Bulwark
        },
        ["coralaerieaerie_001"] = {{0.7, 0.7,
                                    DH_GetLocalizedData("summerset", "coralaerieaerie_001", "shield_guardian"), "SECRET"} -- Shield Guardian
        },
        ["coralaerieb3_001"] = {{0.4, 0.6, DH_GetLocalizedData("summerset", "coralaerieb3_001", "varallion"), "FINAL"} -- Varallion
        },
        ["coralaeriesecretmap001"] = {{0.4, 0.7, DH_GetLocalizedData("summerset", "coralaeriesecretmap001", "zbaza"),
                                       "SECRET"} -- Z'baza
        },

        -- == Cloudrest (TRIAL) ==--
        ["cloudresttrial_base"] = {{0.43, 0.50,
                                    DH_GetLocalizedData("summerset", "cloudresttrial_base", "siroria_silaeda")}, -- Shades of Siroria and Silaeda
                                   {0.44, 0.67,
                                   ...
                                   {0.53, 0.57, DH_GetLocalizedData("summerset", "cloudresttrial_base", "zmaja"),
                                    "FINAL"} -- Z'Maja
        }
    }, -- end Summerset
    ...
    ["systres"] = {
        ...
        ["ere_insidemap01"] = {{0.50, 0.70, DH_GetLocalizedData("systres", "ere_insidemap01", "lutea"), "SECRET"}, -- Lutea
                               {0.70, 0.20, DH_GetLocalizedData("systres", "ere_insidemap01", "corrupt_root")} -- Corruption of Root
        },
        ["ere_outsidemap01"] = {{0.75, 0.54, DH_GetLocalizedData("systres", "ere_outsidemap01", "scalded_roots"),
                                 "SECRET"}, -- Scalded Roots
        {0.61, 0.30, DH_GetLocalizedData("systres", "ere_outsidemap01", "corrupt_stone"), "PUGKILLER"} -- Corruption of Stone
        },
        ["ere_outsidemap02"] = {{0.40, 0.30, DH_GetLocalizedData("systres", "ere_outsidemap02", "jodoro"), "SECRET"}, -- Jodoro
        ...
        ["gravendeep_island_map"] = {{0.61, 0.52, DH_GetLocalizedData("systres", "gravendeep_island_map", "mzugru"),
                                      "SECRET"}, -- Mzugru, the Security Drone
        {0.67, 0.43, DH_GetLocalizedData("systres", "gravendeep_island_map", "gatekeeper")} -- The Euphotic Gatekeeper
        },
        ["gravendeep_section2_map"] = {{0.70, 0.10,
                                        DH_GetLocalizedData("systres", "gravendeep_section2_map", "varzunon")}, -- Varzunon
                                       {0.80, 0.90,
                                        DH_GetLocalizedData("systres", "gravendeep_section2_map", "xzyviian"), "SECRET"} -- Xzyviian, Defense Crawler
        },
        ["gravendeep_section3_map"] = {{0.60, 0.90,
                                        DH_GetLocalizedData("systres", "gravendeep_section3_map", "chralzak"), "SECRET"}, -- Chralzak, Sphere 9402-A
                                       {0.30, 0.30,
                                        DH_GetLocalizedData("systres", "gravendeep_section3_map", "zelvraak"), "FINAL"} -- Zelvraak the Unbreathing
        },
        ...
        ["dsr_b2under_map"] = {},
        ["dsr_b3_map"] = {{0.5, 0.9, DH_GetLocalizedData("systres", "dsr_b3_map", "taleria"), "FINAL"} -- Tideborn Taleria
        },
        ["dsr_beach_01"] = {},
        ...
        ["dsr_doors_map"] = {},
        ["dsr_e_map"] = {{0.5, 0.8, DH_GetLocalizedData("systres", "dsr_e_map", "sail_ripper")} -- Sail Ripper
        },
        ["dsr_v_map"] = {{0.5, 0.7, DH_GetLocalizedData("systres", "dsr_v_map", "bow_breaker")} -- Bow Breaker
        },
        ["dsr_w_map"] = {}
    ...
    ["telvanni"] = {
        ---- Sanity's Edge (TRIAL) ----
        ["se_alinor"] = {{0.60, 0.70, DH_GetLocalizedData("telvanni", "se_alinor", "descender")} -- Spiral Descender
        },
        ["se_orsinium"] = {{0.60, 0.70, DH_GetLocalizedData("telvanni", "se_orsinium", "descender")} -- Spiral Descender (same as alinor one)
        },
        ["sanitysedgeboss1_map"] = {{0.5, 0.5, DH_GetLocalizedData("telvanni", "sanitysedgeboss1_map", "yaselya")} -- Exarchanic Yaselya
        },
        ["sanitysedgeboss2_map"] = {{0.5, 0.7, DH_GetLocalizedData("telvanni", "sanitysedgeboss2_map", "twelvane")} -- Archwizard Twelvane and the Chimera
        },
        ["sanitysedgesection3"] = {{0.5, 0.8, DH_GetLocalizedData("telvanni", "sanitysedgesection3", "ansuul"), "FINAL"} -- Ansuul the Tormentor
        },
        ["bastion_nymic"] = {{0.5, 0.25, DH_GetLocalizedData("telvanni", "bastion_nymic", "strix")}, -- Kynemaster Strix
...
local DHHintData = {
    ...
    ["therift"] = {
        ...
        ["u37_scrivenershall_boss3_map"] = {{0.7, 0.5,
                                             DH_GetLocalizedHintData("therift", "u37_scrivenershall_boss3_map", "scamp1")}, -- Cartoklept Scamp
                                            {0.7, 0.6,
                                             DH_GetLocalizedHintData("therift", "u37_scrivenershall_boss3_map", "scamp2")} -- Cartoklept Scamp
        },
        ["u37_scrivenershall_sect1_map"] = {{0.10, 0.67,
                                             DH_GetLocalizedHintData("therift", "u37_scrivenershall_sect1_map", "vault")}},
        ["u37_scrivenershall_sect2a_map"] = {},
    ...
    ["wrothgar"] = {
        ---- Bedlam Veil (DLC) ----
        ["u41_bv_sc1_map"] = {{0.7, 0.5, DH_GetLocalizedHintData("wrothgar", "u41_bv_sc2_map", "puzzle1")},
                              {0.7, 0.7, DH_GetLocalizedHintData("wrothgar", "u41_bv_sc2_map", "puzzle2")},
                              {0.25, 0.5, DH_GetLocalizedHintData("wrothgar", "u41_bv_sc2_map", "puzzle3")}}
    },
    ["reach"] = {
        ---- Vateshran Hollows (SOLO ARENA) ----
        ["vateshransrites01"] = {},
    ...
    ["telvanni"] = {
        ["bastion_nymic"] = {{0.5, 0.25, DH_GetLocalizedHintData("telvanni", "bastion_nymic", "puzzle_n")},
                             {0.25, 0.75, DH_GetLocalizedHintData("telvanni", "bastion_nymic", "puzzle_sw")},
                             {0.75, 0.75, DH_GetLocalizedHintData("telvanni", "bastion_nymic", "puzzle_se")}}
    }
}
