...
- When the boss disappears, kill the glass remnant adds to make her return.]]}
    ...
    ["skyrim"] = {
        ---- Castle Thorn (DLC) ----
        ["castlethorn_int_01"] = {
            ["twilight"] = {[[Blood Twilight]], [[Mechanics:
- Tank: when the boss disappears, be ready to block a heavy attack when he reappears.
- Everyone: kill the imps that spawn in the corners of the room. While they are alive the boss is buffed.
- When the pool starts filling with blood, get out of it ASAP. Block attacks from 'ghost' versions of the boss, or they will knock you into the pool.
- Everyone: when the Reanimated Vampire add spawns (during blood pool phase), kill it ASAP.]]}
        },
        ["castlethorn_int_02"] = {},
        ["castlethorn_int_03"] = {
            ["lady_thorn"] = {[[Lady Thorn]], [[Mechanics:
- Tank: keep the boss still and facing away from the group.
- Tank: you must block her heavy attack or you will be one-shot.
- The boss will disappear leaving a large ground AoE (bats), which shoots out smaller clouds of bats. You must not touch these.
- After the bats disappear, the boss will reappear and land on a random player. You must move away before she lands or you will be one-shot.
- At 60/20% health, a moving circular light AoE appears. Everyone must stay in the light. The boss will charge at random players, this can be dodged or blocked.
- While the light is present, scamp adds will spawn. Kill these and collect their synergy 4x to make the boss reappear.
- While the light is present, a Guardian add will spawn periodically. These must be killed ASAP as more than one will overwhelm the group.

|cffcc66Hard Mode
- When the circle of light appears for the second time (20% health), its mechanics will continue for the rest of the fight.|r]]}
        },
        ["castlethornmap_001"] = {
            ["tindulra"] = {[[Dread Tindulra]], [[Mechanics:
- Tank: keep the boss facing away from the group. Keep movement to a minimum.
- Everyone: when the boss spits fireballs in the air, these land to form ground AoEs. Move out of them, since when the boss stomps they will explode and one-shot you.
- Everyone: when the boss charges and knocks a player down, you MUST interrupt his bites or the player will be killed.
- Everyone: don't move too far from the boss or you will trigger his charge.]]},
            ["vaduroth"] = {[[Vaduroth]], [[Mechanics:
- Tank: keep the boss taunted and facing away from the group.
- Tank: you MUST block his heavy attack or it will one-shot you.
- Everyone: if you are targeted by a group of crows, kite it away from the group until it disappears.
- At 75/50/25% health, the boss throws his scythe, draws in all players, and puts a 'bomb' AoE under all players' feet. You must all spread out, as if any AoEs overlap when the bombs explode, both players will be killed.
- When adds spawn, kill them ASAP before focusing on the boss.]]},
            ["talfyg"] = {[[Talfyg]], [[Mechanics:
- Tank: keep boss movement to a minimum.
- Everyone: the boss will pound the ground and create a large AoE. The tank can step out of this, everyone else must avoid it altogether.
- Everyone: the gargoyles that spawn at the edges of the room are a higher priority than the boss.
- At low health, the boss will raise his hand and fire a laser beam. You MUST spread out and kite the laser, or it will kill you.]]}
        },
...
- Activating his totem (blue) gives a large amount of bonus flame damage when you make a light or heavy attack.]]}
    ...
    ["blackwood"] = {
        ...
        ["tdc_map_inside_001"] = {
            ["cyronin"] = {[[Cyronin Artellian]], [[Mechanics:
- Tank: keep the boss taunted and facing away from the group.
- Heavy attack can be blocked by the tank, but other players must avoid it or be one-shot.
- When the boss emits red waves, you must move into the gap in each wave or be killed.
- When the boss spins his staff and shoots out winds, you can block them or move between them.
- When the boss raises his staff and summons skulls, you must dodge each skull with RED EYES as it will be targeting you.
- Kill lightning wraiths ASAP, otherwise they will snare players, making you vulnerable to other mechanics.
- The two atronach adds can be killed, or they can be interrupted when channeling to prevent lightning AoEs.

|cffcc66Hard Mode:
- The boss will sometimes cast a lightning AoE on 2 players. They must move away from the group to avoid stacking.|r]]},
            ["magma_incarnate"] = {[[Magma Incarnate]], [[Mechanics:
- Tank: keep the boss taunted and located near the MIDDLE of the room.
- Tank: when the boss channels with his swords in the ground, you MUST block throughout.
- At 60/30% health, the boss surrounds himself with a bubble, and a portal appears at the other end of the arena. Players must RUN to the portal and enter it (taking damage until they do so). Inside the portal, kill the totem.
- After the first portal, the boss will create a moving wall of winds. This has a gap near the middle, which you must pass through.
- The boss will target 3 players with a beam, then hurl an attack at them which applies a fire DOT. Players must spread out to avoid stacking.
- Healer: after players are targetted by beams, you must out-heal their fire DOT (5 seconds).
- When scamps spawn, they are a higher priority than the boss, otherwise they will build up and overwhelm the group.

|cffcc66Hard Mode:
- After returning from each portal, there will be a giant spider add which must be taunted and killed ASAP.
- The beam attacks leave a ground AoE at the player's position.|r]]}
        },
        ["tdc_map_outside_001"] = {
            ["broodlord"] = {[[Scorion Broodlord]], [[Mechanics:
- Tank: keep the boss taunted and facing away from the group.
- Heavy attack must be dodged or avoided (the tank can block it).
- The boss will teleport to a random pillar and start siphoning energy from it, dealing damage to the group. Destroy the pillar ASAP.
- The boss will pull and pin a random player. This must be interrupted or the player will die.
- Healer: the boss will curse random players, you must out-heal this to keep the player alive.
- The boss will pull in all players while channeling an AoE. Move out of this ASAP.
- Xivkyn adds are a higher priority than the boss, as too many will overwhelm the group.

|cffcc66Hard Mode:
- Bone collosi and daedroths will also spawn during the fight. These MUST be taunted and killed ASAP.|r]]}
        },
        ["tdc_map_secret_001"] = {},
        ["tdc_map_secrethall_001"] = {
            ["purgator"] = {[[Purgator]], [[Mechanics:
- Tank: keep the boss taunted and facing away from the group.
- Keep the flame atronachs under control to avoid being overwhelmed.
- When the boss swings his hammer onto the ground, a meteor will land on each player soon afterwards. Players must spread out to avoid stacking, then block or step out of the AoE.]]}
        },
        ["tdc_map_secrethall_002"] = {
            ["undertaker"] = {[[Undertaker]], [[Mechanics:
- Tank: keep boss movement to a minimum, and keep the boss facing away from the group.
- Skeleton adds will spawn during the fight, in increasing numbers as the boss' health falls. Keep their population under control to avoid being overwhelmed.
- Avoid the various AoEs and exploding crystals that the boss creates during the fight.]]}
        },
        ["tdc_map_secrethall_003"] = {
            ["warden"] = {[[Grim Warden]], [[Mechanics:
- Tank: keep the boss taunted and facing away from the group.
- Tank: block the boss' heavy attacks and his beam attack.
- Tank: when the boss starts spinning, maintain taunt and kite the boss until the spinning stops.
- Kill the adds that spawn during the fight. If too many are in the room, the boss will become invulnerable.
- Everyone: if you are targeted with a spinning wind, move away from the group.]]}
        },
...
local DHLocalizedHintData = {
    ["stonefalls"] = {
        ["balsunn_presenttown01"] = {
            ["totem_puzzle"] = {[[Totem Puzzle]],
                                [[Solve to get the |c00FF00Strength of the Ancestors|r group buff for the rest of the dungeon. This buff increases weapon and spell damage.]]},
            ["laser_puzzle"] = {[[Laser Puzzle]],
                                [[Solve to get the |c00FF00Ancestral Resolve|r group buff for the rest of the dungeon. This buff increases maximum health and reduces damage taken.]]}
        }
    },
    ["therift"] = {
        ---- Scrivener's Hall (DLC) ----
...
- A passage will open. Follow it and defeat the enemies to gain access to a chest.]]},
            ["puzzle_n"] = {[[Nightmare's Puzzle]],
                            [[- Look for floating purple flames. Approach them and defeat the Nightmare that spawns.
...
function DH_GetLocalizedData(zone, subzone, bossId)
    if type(zone) == "string" and type(subzone) == "string" and type(bossId) == "string" and DHLocalizedData[zone] and
        DHLocalizedData[zone][subzone] and DHLocalizedData[zone][subzone][bossId] then
...
function DH_GetLocalizedHintData(zone, subzone, hintId)
    if type(zone) == "string" and type(subzone) == "string" and type(hintId) == "string" and DHLocalizedHintData[zone] and
        DHLocalizedHintData[zone][subzone] and DHLocalizedHintData[zone][subzone][hintId] then
